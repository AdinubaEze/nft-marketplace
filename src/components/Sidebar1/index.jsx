        ...
        <div className="bg-gray-50 border-gray-100 border-r-[1.5px] border-solid flex flex-col gap-[50px] items-start justify-start py-[34px] w-full">
          ...
          <div className="md:h-[231px] h-[258px] md:ml-[0] ml-[34px] relative w-[78%]">
            <div className="absolute bg-gray-900 bottom-[0] flex flex-col inset-x-[0] items-center justify-end mx-auto p-3.5 rounded-[15px] w-[234px]">
              ...
              <Button className="bg-white-A700 cursor-pointer font-medium font-urbanist min-w-[206px] mt-[34px] py-3 rounded-[10px] text-center text-gray-900 text-sm tracking-[0.14px]">
                Go To Help Center
              </Button>
            </div>
            <Button className="absolute bg-white-A700 flex h-[50px] inset-x-[0] items-center justify-center mx-auto p-[13px] rounded-[50%] shadow-bs top-[0] w-[50px]">
              <Img
                className="h-6"
