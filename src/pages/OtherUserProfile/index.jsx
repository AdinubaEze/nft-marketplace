              ...
              <div className="bg-white-A700 flex flex-col gap-6 items-center justify-center mb-[272px] p-[18px] rounded-[15px] shadow-bs1 w-[23%] md:w-full">
                ...
                <div className="flex flex-col items-center justify-start mb-2.5 w-full">
                  ...
                  <div className="flex flex-row gap-3 items-center justify-between mt-6 w-[87%] md:w-full">
                    <Button className="bg-gray-900 cursor-pointer font-medium min-w-[88px] py-[9px] rounded-lg text-center text-white-A700 text-xs tracking-[0.12px]">
                      Follow
                    </Button>
                    <Button className="flex h-8 items-center justify-center outline outline-[0.75px] outline-gray-100 p-[7px] rounded-lg w-8">
                      <Img
                        className="h-[18px]"
              ...
              <div className="flex flex-col gap-[34px] items-center justify-start md:mt-0 mt-[118px] w-3/4 md:w-full">
                <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                  <div className="flex sm:flex-1 flex-row gap-3 items-center justify-between w-[44%] sm:w-full">
                    <Button
                      className="bg-black-900 cursor-pointer flex items-center justify-center min-w-[107px] pr-3 py-[9px] rounded-[18px]"
                      leftIcon={
                        <Img
                    ...
                    >
                      <div className="font-medium text-left text-sm text-white-A700 tracking-[0.14px]">
                        Created
                      </div>
                    </Button>
                  ...
                  <Input
                    ...
                    className="p-0 placeholder:text-gray-500 sm:pr-5 text-gray-500 text-left text-xs tracking-[0.12px] w-full"
                    wrapClassName="border border-gray-300 border-solid flex sm:flex-1 pr-[35px] py-3 rounded-lg sm:w-full"
                    prefix={
                      <Img
