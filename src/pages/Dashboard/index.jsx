                ...
                >
                  <div className="bg-gradient  flex flex-col gap-[34px] items-start justify-center p-[30px] sm:px-5 rounded-[15px] w-full">
                    ...
                    <div className="flex flex-row gap-5 items-center justify-start mb-[19px] w-[39%] md:w-full">
                      <Button className="bg-white-A700 cursor-pointer font-semibold min-w-[120px] py-[13px] rounded-lg text-center text-gray-900 text-sm tracking-[0.14px]">
                        Explore More
                      </Button>
                      <Button className="cursor-pointer font-semibold min-w-[120px] outline outline-[0.75px] outline-white-A700 py-[13px] rounded-lg text-center text-sm text-white-A700 tracking-[0.14px]">
                        Sell Artwork
                      </Button>
                    </div>
                  </div>
                  ...
                  <div className="bg-white-A700 flex flex-1 flex-col gap-5 items-center justify-start p-1.5 rounded-[15px] shadow-bs1 w-full">
                    ...
                    <div className="flex flex-col gap-[18px] items-start justify-start mb-3 w-[93%] md:w-full">
                      ...
                      <div className="flex flex-row gap-[38px] items-center justify-between w-full">
                        ...
                        <Button className="bg-gray-900 cursor-pointer font-medium font-urbanist min-w-[88px] py-[9px] rounded-lg text-center text-white-A700 text-xs tracking-[0.12px]">
                          Place a Bid
                        </Button>
                      </div>
                    </div>
                ...
                <div className="bg-white-A700 flex flex-col gap-3 items-center justify-start p-1.5 rounded-[15px] shadow-bs2 w-full">
                  ...
                  <div className="flex flex-col gap-3 items-center justify-start mb-2 w-[94%] md:w-full">
                    <div className="flex flex-row items-center justify-between w-full">
                      ...
                      <Button className="bg-gray-900 cursor-pointer font-outfit min-w-[64px] my-[5px] py-[7px] rounded-[14px] text-center text-white-A700 text-xs tracking-[0.12px]">
                        Follow
                      </Button>
                    </div>
