            ...
            <div className="flex md:flex-col flex-row md:gap-[50px] items-center justify-between mt-[34px] w-[99%] md:w-full">
              ...
              <div className="flex flex-col items-start justify-start">
                ...
                <div className="flex flex-row gap-10 items-start justify-start mt-[21px] pr-1 w-[68%] md:w-full">
                  <div className="flex flex-col gap-3.5 items-start justify-start w-[52%]">
                    ...
                    <div className="flex flex-row items-center justify-evenly w-full">
                      <Button className="bg-gray-50 cursor-pointer font-semibold h-11 py-[9px] rounded-lg text-black-900 text-center text-xl tracking-[0.20px] w-11">
                        03
                      </Button>
                      <Img
                ...
                <div className="flex flex-row gap-3.5 items-center justify-start mt-[37px] w-[56%] md:w-full">
                  <Button className="flex h-[50px] items-center justify-center outline outline-[0.75px] outline-gray-100 p-[13px] rounded-lg w-[50px]">
                    <Img
                      className="h-6"
                  ...
                  <Button className="bg-gray-900 cursor-pointer font-medium min-w-[210px] py-4 rounded-lg text-center text-sm text-white-A700 tracking-[0.14px]">
                    Place A Bid
                  </Button>
                </div>
              </div>
