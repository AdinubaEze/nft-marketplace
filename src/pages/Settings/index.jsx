          ...
          <div className="flex flex-col gap-[50px] items-start justify-start mx-auto my-[34px] w-[89%]">
            ...
            <div className="font-urbanist md:h-[246px] h-[258px] ml-4 md:ml-[0] relative w-[88%]">
              ...
              <div className="absolute flex flex-col gap-3.5 inset-x-[0] items-center justify-start mx-auto top-[0] w-[91%]">
                <Button className="bg-white-A700 flex h-[50px] items-center justify-center p-[13px] rounded-[50%] shadow-bs w-[50px]">
                  <Img
                    className="h-6"
                ...
                <div className="flex flex-col gap-[30px] items-center justify-start w-full">
                  ...
                  <Button className="bg-white-A700 cursor-pointer font-medium min-w-[206px] py-[11px] rounded-[10px] text-center text-gray-900 text-sm tracking-[0.14px]">
                    Go To Help Center
                  </Button>
                </div>
              </div>
        ...
        <div className="flex flex-1 flex-col gap-[34px] items-center justify-start md:px-5 w-full">
          <div className="bg-white-A700 flex md:flex-col flex-row md:gap-10 items-center justify-between outline outline-gray-100 p-[34px] sm:px-5 w-full">
            <Input
              ...
              className="p-0 placeholder:text-gray-500 sm:pr-5 text-gray-500 text-left text-sm tracking-[0.14px] w-full"
              wrapClassName="bg-white-A700 border border-gray-300 border-solid flex md:flex-1 md:mt-0 my-0.5 pr-[35px] py-[17px] rounded-[15px] md:w-full"
              prefix={
                <Img
            ...
            <div className="flex flex-row font-urbanist gap-[30px] items-center justify-center md:mt-0 my-0.5">
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[137px] outline outline-[0.75px] outline-gray-100 pr-[19px] py-[15px] rounded-[10px]"
                leftIcon={
                  <Img
              ...
              >
                <div className="font-medium text-base text-black-900 text-left tracking-[0.16px]">
                  3,421 ETH
                </div>
              </Button>
              <Button className="flex h-[52px] items-center justify-center outline outline-[0.75px] outline-gray-100 p-3.5 rounded-[50%] w-[52px]">
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
              ...
              <div className="flex md:flex-1 sm:flex-col flex-row gap-[18px] items-center justify-between w-[43%] md:w-full">
                ...
                <div className="flex flex-row gap-3 items-center justify-between w-1/2 sm:w-full">
                  <Button className="bg-gray-900 cursor-pointer font-medium min-w-[106px] py-3 rounded-lg text-center text-sm text-white-A700 tracking-[0.14px]">
                    Preview
                  </Button>
                  <Button className="bg-gray-100 cursor-pointer font-medium min-w-[106px] py-3 rounded-lg text-center text-gray-500 text-sm tracking-[0.14px]">
                    Cancel
                  </Button>
                </div>
              </div>
                      ...
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
                          <div className="flex md:flex-1 flex-col gap-3 items-start justify-start w-[49%] md:w-full">
                            ...
                            <Input
                              ...
                              placeholder="Kevin"
                              className="p-0 placeholder:text-black-900 sm:pr-5 text-black-900 text-left text-sm tracking-[0.14px] w-full"
                              wrapClassName="border border-gray-400 border-solid flex pr-[35px] py-[18px] rounded-lg w-full"
                              prefix={
                                <Img
                          ...
                          <div className="flex md:flex-1 flex-col gap-3 items-start justify-start w-[49%] md:w-full">
                            ...
                            <Input
                              ...
                              placeholder="Cranel"
                              className="p-0 placeholder:text-black-900 sm:pr-5 text-black-900 text-left text-sm tracking-[0.14px] w-full"
                              wrapClassName="border border-gray-400 border-solid pl-4 pr-[35px] py-[18px] rounded-lg w-full"
                            ></Input>
                          </div>
                        </div>
                        <div className="flex flex-col gap-3 items-start justify-start mt-6 w-full">
                          ...
                          <Input
                            ...
                            className="p-0 placeholder:text-black-900 text-black-900 text-left text-sm tracking-[0.14px] w-full"
                            wrapClassName="border border-gray-400 border-solid flex py-[18px] rounded-lg w-full"
                            type="email"
                            prefix={
                              <Img
                                className="mt-3.5 mb-[13px] h-6 ml-4 mr-3"
                        ...
                        <div className="flex flex-col gap-3 items-start justify-start mt-[26px] w-full">
                          ...
                          <Input
                            ...
                            wrapClassName="border border-gray-400 border-solid flex rounded-lg w-full"
                            prefix={
                              <Img
                        ...
                        <div className="flex flex-col gap-3 items-start justify-start mt-6 w-full">
                          ...
                          <TextArea
                            className="border border-gray-400 border-solid pb-[35px] pl-4 sm:pr-5 pr-[35px] pt-[23px] rounded-lg placeholder:text-black-900 text-black-900 text-left text-sm tracking-[0.14px] w-full"
                ...
                <div className="bg-white-A700 flex flex-col gap-[33px] items-center justify-start outline outline-[0.75px] outline-gray-100 py-6 rounded-[15px] shadow-bs1 w-full">
                  ...
                  <div className="flex flex-col gap-6 items-start justify-start w-[86%] md:w-full">
                    ...
                    <div className="bg-white-A700 flex flex-col gap-3.5 items-center justify-start outline-[0.75px] outline-dashed outline-gray-901 p-3.5 rounded-[15px] w-full">
                      <Button className="bg-gray-50 flex h-12 items-center justify-center p-[13px] rounded-[50%] w-12">
                        <Img
                          className="h-[22px]"
                  ...
                  <div className="flex flex-col gap-[11px] items-start justify-start w-[86%] md:w-full">
                    <div className="flex flex-row items-center justify-between w-full">
                      <Img
                        ...
                        alt="signal"
                      />
                      <Button className="bg-green-600 cursor-pointer font-medium min-w-[96px] py-1.5 rounded-lg text-center text-sm text-white-A700 tracking-[0.14px]">
                        Connected
                      </Button>
                    </div>
                    <div className="flex flex-col gap-2.5 items-start justify-start">
