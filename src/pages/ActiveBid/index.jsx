        ...
        <div className="flex flex-1 flex-col gap-[34px] items-center justify-start md:px-5 w-full">
          ...
          <div className="flex flex-col font-urbanist items-start justify-start w-[94%] md:w-full">
            ...
            <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start mt-5 rounded-[14px] w-full">
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[135px] outline outline-[0.75px] outline-gray-100 pr-4 py-[15px] rounded-[14px]"
                leftIcon={
                  <Img
                    className="h-6 ml-4 mr-2.5 my-3.5"
              ...
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[134px] ml-6 sm:ml-[0] outline outline-[0.75px] outline-gray-100 pr-4 py-[15px] rounded-[14px]"
                leftIcon={
                  <Img
                    className="h-6 ml-4 mr-2.5 my-3.5"
              ...
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[151px] ml-72 sm:ml-[0] outline outline-[0.75px] outline-gray-100 pr-4 py-[15px] rounded-[14px]"
                leftIcon={
                  <Img
                    className="h-6 ml-4 mr-2.5 my-3.5"
