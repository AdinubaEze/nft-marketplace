          ...
          <div className="flex flex-col font-urbanist gap-5 items-start justify-start w-[95%] md:w-full">
            ...
            <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] w-full">
              <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start rounded-[14px] w-full">
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[134px] outline outline-[0.75px] outline-gray-100 pr-4 py-[15px] rounded-[14px]"
                  leftIcon={
                    <Img
                      className="h-6 ml-4 mr-2.5 my-3.5"
                ...
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[137px] ml-6 sm:ml-[0] outline outline-[0.75px] outline-gray-100 pr-4 py-[15px] rounded-[14px]"
                  leftIcon={
                    <Img
                      className="h-6 ml-4 mr-2.5 my-3.5"
                ...
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[151px] ml-6 sm:ml-[0] outline outline-[0.75px] outline-gray-100 pr-4 py-[15px] rounded-[14px]"
                  leftIcon={
                    <Img
                      className="h-6 ml-4 mr-2.5 my-3.5"
                ...
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[151px] sm:ml-[0] ml-[447px] outline outline-[0.75px] outline-gray-100 pr-4 py-[15px] rounded-[14px]"
                  leftIcon={
                    <Img
                      className="h-6 ml-4 mr-2.5 my-3.5"
                  ...
                  <div className="bg-white-A700 flex flex-1 flex-col gap-5 items-center justify-start p-1.5 rounded-[15px] shadow-bs1 w-full">
                    ...
                    >
                      <div className="flex flex-row gap-2 items-center justify-end mb-[94px] w-[51%] md:w-full">
                        <Button className="bg-gray-900_26 cursor-pointer font-medium min-w-[75px] py-[7px] rounded-[14px] text-center text-white-A700 text-xs tracking-[0.12px]">
                          2h 4m 32s
                        </Button>
                        <Button className="bg-gray-900_26 flex h-[30px] items-center justify-center p-1.5 rounded-[50%] w-[30px]">
                          <Img
                            className="h-[18px]"
                    ...
                    <div className="flex flex-col gap-[18px] items-start justify-start mb-3 w-[94%] md:w-full">
                      ...
                      <div className="flex flex-row items-center justify-between w-full">
                        ...
                        <Button
                          className="common-pointer bg-gray-900 cursor-pointer font-medium font-urbanist min-w-[88px] py-[9px] rounded-lg text-center text-white-A700 text-xs tracking-[0.12px]"
              ...
              <Button className="cursor-pointer font-medium min-w-[106px] mt-[50px] outline outline-[0.5px] outline-gray-900 py-2 rounded-lg text-center text-gray-900 text-sm tracking-[0.14px]">
                Load More
              </Button>
            </div>
          </div>
